...
window.sendLocationUpdate = function sendLocationUpdate(x, y, direction, w, h, laser, shield) {
    if(!nick) {
        return;
    }

    socket.emit('locationUpdate', {"x":x, "y":y, "direction":direction, "w":w, "h":h, "laser":laser, "shield":shield});
}
